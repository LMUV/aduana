...
<body>
   ...
   <a href="Historial.aspx" aria-class="active" >Historial</a>
    ...
    <asp:LinkButton ID="btnSalir" runat="server" CssClass="logout" OnClick="btnSalir_Click">Salir</asp:LinkButton>
      ...
      <h3 class="sistem">Historial de declaraciones</h3>
    ...
    <div class="main-content">
     ...
     <a href="Notificaciones.aspx">
         <img src="Imagenes/notificacion.png" alt="Mercancias" />
