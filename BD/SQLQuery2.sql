...
CREATE DATABASE SistemaAduanero;
GO

USE SistemaAduanero;
GO

CREATE LOGIN adminaduana WITH PASSWORD = 'Administrador1';
CREATE USER adminaduana FOR LOGIN adminaduana;
EXEC sp_addrolemember 'db_owner', 'adminaduana';
...
(2, '2025-11-12 10:15', 'Aprobado', 2, 'Equipaje normal'),
...
WHERE Resultado = 'Aprobado'
  AND CAST(FechaRevision AS DATE) = CAST(GETDATE() AS DATE);
