<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Declaraciones.aspx.cs" Inherits="aduana.Declaraciones" %>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="utf-8" />
    ...
    <style>
        /* Reutiliza estilo de sistema para encabezado */
        ...
        <div class="card">
            ...
            <asp:Panel ID="pnlForm" runat="server">
                ...
                <asp:DropDownList ID="ddlEstado" runat="server">
                    ...
                    <asp:ListItem>Liberada</asp:ListItem>
                    <asp:ListItem>Incautada</asp:ListItem>
                </asp:DropDownList>
                ...
                <div class="actions">
                    <asp:Button ID="btnCrear" runat="server" CssClass="btn" Text="Crear declaración y añadir mercancías" OnClick="btnCrear_Click" />
                </div>
            </asp:Panel>
        </div>
    </div>
