...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="actions">
                <asp:Button ID="btnAgregar" runat="server" CssClass="btn" Text="Agregar mercancía" OnClick="btnAgregar_Click" />
                &nbsp;
        ...
        <div class="card">
            ...
            <asp:GridView ID="gvMercancias" runat="server" AutoGenerateColumns="false" CssClass="grid">
                <Columns>
